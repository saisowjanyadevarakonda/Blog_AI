...
const Header = () => {
  return (
    ...
    <div className='inline-flex items-cneter  justify-center gap-4 px-6 py-1.5 mb-4 border border-primary/40 bg-primary/10 rounded-full text-sm text-primary'>
  ...
  <p className='my-6 sm:my-8 max-w-2xl mx-auto max-sm:text-xs text-gray-500 text-center'>
        ...
        This is your space to think out loud to share what matters, and to write without filters , whether it's one word or thousand, your story start right here.
    </p>
